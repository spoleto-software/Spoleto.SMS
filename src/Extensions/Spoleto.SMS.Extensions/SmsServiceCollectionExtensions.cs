...
namespace Spoleto.SMS.Extensions.Messaging
{
    ...
    public static class SmsServiceCollectionExtensions
    {
        ...
        public static SmsServiceBuilder AddSMSNet(this IServiceCollection serviceCollection, string defaultProviderName)
            => AddSMSNet(serviceCollection, options => options.DefaultFrom = defaultProviderName);
        ...
        public static SmsServiceBuilder AddSMSNet(this IServiceCollection serviceCollection, Action<SmsServiceOptions> config)
        {
            if (config is null)
